...
#Balls
#test 2 ball collision
ball1 = create_ball(ball_diameter/2,(350,300))
ball2 = create_ball(ball_diameter/2,(450,300))

#test if collided ball will interact with pots correctly
ball3 = create_ball(ball_diameter/2,(170,135))
ball4 = create_ball(ball_diameter/2,(120,100))

#test if more than 2 balls can be collided
ball5 = create_ball(ball_diameter/2,(400,130))
ball6 = create_ball(ball_diameter/2,(400,100))
ball7 = create_ball(ball_diameter/2,(500,115))
...
testForce(ball2,1000,00)
testForce(ball3,900,320)
testForce(ball7,1000,0)
