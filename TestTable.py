...
#Balls
#Testing y axis reflection
ballY1 = create_ball(ball_diameter/2,(250,400))
ballY2 = create_ball(ball_diameter/2,(350,400))
ballY3 = create_ball(ball_diameter/2,(450,400))


#Testing x axis reflection
ballX1 = create_ball(ball_diameter/2,(200,150))
ballX2 = create_ball(ball_diameter/2,(200,200))
ballX3 = create_ball(ball_diameter/2,(200,250))

balls = {ballY1,ballY2,ballY3, ballX1, ballX2,ballX3}
...
#The balls will test, in order, if the ball will bounce of the wall, if force is sustained well after collision, if the ball will 
#change direction correctly when hitting the wall at an angle
#
testForce(ballY1,1000,90)
testForce(ballY2,2000,90)
testForce(ballY3,1500,125)

testForce(ballX1,1000,0)
testForce(ballX2,2000,0)
testForce(ballX3,1600,45)
